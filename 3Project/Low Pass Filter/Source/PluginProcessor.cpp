...
void LowPassFilterAudioProcessor::calculateTopCoefficients(float coefficients[]) {
    coefficients[0] = 1;
    coefficients[1] = 4;
    coefficients[2] = 6;
    coefficients[3] = 4;
...
float LowPassFilterAudioProcessor::calculateDCGain(std::complex<float> zPoles[], float topCoefficients[]) {
    float tempTop = 0.0f;
