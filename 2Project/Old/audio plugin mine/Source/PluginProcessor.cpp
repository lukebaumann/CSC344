...
public:
    ...
    void renderNextBlock (AudioSampleBuffer& outputBuffer, int startSample, int numSamples)
    {
        if (angleDelta != 0.0)
        {
            const currentSampleTemp = sin (currentAngle);
            if (tailOff > 0)
            {
                while (--numSamples >= 0)
                {
...
public:
    ...
    void renderNextBlock (AudioSampleBuffer& outputBuffer, int startSample, int numSamples)
    {
        if (angleDelta != 0.0)
        {
            const currentSampleTemp = currentAngle > cyclesPerSample / 2 ? 1.0 : -1.0;
            if (tailOff > 0)
            {
                while (--numSamples >= 0)
                {
...
public:
    ...
    void renderNextBlock (AudioSampleBuffer& outputBuffer, int startSample, int numSamples)
    {
        if (angleDelta != 0.0)
        {
            const currentSampleTemp = currentAngle > double_Pi ? (currentAngle) * 2 / double_Pi : (double_Pi - currentAngle) * 2 / double_Pi;
            if (tailOff > 0)
            {
                while (--numSamples >= 0)
                {
...
public:
    ...
    void renderNextBlock (AudioSampleBuffer& outputBuffer, int startSample, int numSamples)
    {
        if (angleDelta != 0.0)
        {
            const currentSampleTemp = currentAngle / double_Pi;
            if (tailOff > 0)
            {
                while (--numSamples >= 0)
                {
