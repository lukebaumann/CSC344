...
const static int WINDOW_DELTA = 441;
...
const static int FREQUENCY_BAR_WIDTH = LEFT_MOST_FREQUENCY_BAR + (RIGHT_MOST_FREQUENCY_BAR - LEFT_MOST_FREQUENCY_BAR) / (double) NUMBER_OF_FREQUENCIES - WIDTH + RIGHT_MOST_FREQUENCY_BAR;
